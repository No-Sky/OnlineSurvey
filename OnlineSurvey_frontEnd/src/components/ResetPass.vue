        ...
        <el-row>
          ...
          <el-form :model="rpwForm" status-icon :rules="rules" ref="rpwForm" label-width="100px" class="demo-rpwForm">
            <el-form-item prop="username" label="用户名">
              <el-input @keyup.enter="rpw('rpwForm')" v-model="rpwForm.username" placeholder="请输入用户名"></el-input>
            </el-form-item>
            <el-form-item prop="email" label="邮  箱">
              <el-input @keyup.enter="rpw('rpwForm')" v-model="rpwForm.email" placeholder="请输入邮箱"></el-input>
            </el-form-item>
            <el-form-item>
              <!-- 提示信息 -->
